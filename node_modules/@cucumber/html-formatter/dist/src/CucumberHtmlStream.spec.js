...
function renderAsHtml(...envelopes) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            const cucumberHtmlStream = new CucumberHtmlStream_1.CucumberHtmlStream(`${__dirname}/dummy.css`, `${__dirname}/dummy.js`);
...
describe('CucumberHtmlStream', () => {
    ...
    it('escapes forward slashes', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const html = yield renderAsHtml(e1);
        (0, assert_1.default)(html.indexOf(`window.CUCUMBER_MESSAGES = [{"gherkinDocument":{"comments":[{"location":{"line":0,"column":0},"text":"\\x3C/script>\\x3Cscript>alert('Hello')\\x3C/script>"}]}}];`) >= 0);
    }));
});
