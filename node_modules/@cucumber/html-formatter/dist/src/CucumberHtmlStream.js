...
class CucumberHtmlStream extends stream_1.Transform {
     ...
     * @param iconPath
     */
    constructor(cssPath = path_1.default.join(__dirname, '..', 'main.css'), jsPath = path_1.default.join(__dirname, '..', 'main.js'), iconPath = path_1.default.join(__dirname, 'icon.url')) {
